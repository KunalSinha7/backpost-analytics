...
Thank you for your interest in contributing to The Backpost - Analytics! 🙇

## Discuss Big Changes First

For **big changes** (new features, architectural changes, significant refactoring), please start by opening a [GitHub Issue](https://github.com/KunalSinha7/backpost-analytics/issues) first. This allows for feedback on the approach before you invest significant time in implementation.
...
If you would like to add a new dependency, create a new [Issue](https://github.com/KunalSinha7/backpost-analytics/issues) to explain why.
...
If you have questions about contributing, feel free to open a [GitHub Issue](https://github.com/KunalSinha7/backpost-analytics/issues).
